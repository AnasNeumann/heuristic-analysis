...
public class StudentTestAnalyzer extends GenericAnalyzer {
	 ...
	 * Constantes 
	 */
	private Map<Integer,Map<Integer,Double>> CRITICAL_VALUES = new HashMap<Integer,Map<Integer,Double>>();
	private final String AVERAGE = "average";
	private final String STANDARD = "standard";

    /**
     * Comparer deux heuristiques selon le test des moyennes de students
     * @param h1
     * @param h2
     * @param n
     * @return
	...
	public SingleAverageStudentTestDto analyze(HeuristicVo h1, HeuristicVo h2, Integer n) {
		...
		return new SingleAverageStudentTestDto().setName(h2.getName()).setValue(value).setT20(getT(n, 50)).setT5(getT(n, 5));
	}
	...
	public Double getT(Integer n, Integer a) {
		return this.criticalValue().get(a).get((2*n)-2);
	}
	
   /**
    * Récuperer la table des valeurs critiques de student 
    * @return CRITICAL_VALUES_5
    */
   public Map<Integer,Map<Integer,Double>> criticalValue(){
	   if(!CRITICAL_VALUES.isEmpty()) {
		   return CRITICAL_VALUES;
	   }   
	   Map<Integer,Double> CRITICAL_VALUES_5 = new HashMap<Integer,Double>();
	   ...
	   CRITICAL_VALUES.put(5,CRITICAL_VALUES_5);	   
	   Map<Integer,Double> CRITICAL_VALUES_50 = new HashMap<Integer,Double>();
	   ...
	   CRITICAL_VALUES.put(50,CRITICAL_VALUES_50);
	   return CRITICAL_VALUES;
   }
}
